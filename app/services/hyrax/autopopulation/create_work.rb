    ...
    class CreateWork
      ...
      private
        ...
        def actor_environment
          ...
          crossref_type = fetch_crossref_types(@attributes[:doi])
          puts "LOG_crossref_work_type_create_work_53 #{crossref_type.inspect}"
          crossref_work_type = crossref_type[:crossref_work_types]
